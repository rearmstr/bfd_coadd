...
def worker(weight_n,weight_sigma,sigma_step,sigma_max,xy_max,sn_min,ngal,target,template,file,name,label,
           factor,output_dir,index,nobs_cov,use_noise_ps,sigma,psf_seed,seed,interp,flat_wcs,noise_n):
    ...
    for i in range(nobs_cov):
        obs_test = sims(psf_seed=psf_seed)
        coadd_image = coaddsim.CoaddImages(obs_test, interp=interp, flat_wcs=flat_wcs, noise_n=noise_n)
    ...
    for i in range(ngal):
        ...
        coadd_image = coaddsim.CoaddImages(obs_list, interp=interp, flat_wcs=flat_wcs, noise_n=noise_n)
        coadd = coadd_image.get_mean_coadd()
...
if __name__ == '__main__':
    ...
    for i in range(args.njobs):
        ...
        arg=(args.weight_n,args.weight_sigma,args.sigma_step,args.sigma_max,args.xy_max,args.sn_min,args.ngal,
             ...
             args.nobs_cov,args.use_noise_ps,args.sigma,args.psf_seed,args.seed,args.interp,args.flat_wcs,args.noise_n)
